    ...
    <div className="min-h-screen bg-gray-50 pt-20">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="bg-white p-8 rounded-xl shadow-sm">
          ...
          <p className="text-gray-600 mb-8">Last updated: December 9, 2023</p>
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6">
              <li><strong>Application</strong> means the software program provided by the Company downloaded by You on any electronic device, named Mellapay</li>
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Mellapay LLC, Silver Spring, Maryland 20902.</li>
              ...
              <li><strong>Website</strong> refers to Mellapay, accessible from https://www.Mellapay.com/</li>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">Content Restrictions</h3>
            ...
            <h2 className="text-2xl font-bold mt-8 mb-4">Content Backups</h2>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">Intellectual Property Infringement</h3>
            ...
            <p>If You are a copyright owner, or authorized on behalf of one, and You believe that the copyrighted work has been copied in a way that constitutes copyright infringement that is taking place through the Service, You must submit Your notice in writing to the attention of our copyright agent via email at info@Mellapay.com and include in Your notice a detailed description of the alleged infringement.</p>
            ...
            <h3 className="text-xl font-semibold mt-6 mb-3">DMCA Notice and DMCA Procedure for Copyright Infringement Claims</h3>
            ...
            <p>You can contact our copyright agent via email at info@Mellapay.com. Upon receipt of a notification, the Company will take whatever action, in its sole discretion, it deems appropriate, including removal of the challenged content from the Service.</p>
            ...
            <ul className="list-disc pl-6 mb-6">
              <li>By email: info@mellapay.com</li>
              <li>By visiting this page on our website: https://www.Mellapay.com/contact-us</li>
            </ul>
          </div>
        </div>
      </div>
